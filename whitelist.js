        ...
        if (interaction.isCommand()) {
          if (interaction.commandName == "setup") {
              ...
              applyChannel.send({
                embeds: [
                  new EmbedBuilder()
                    ...
                    .setColor("#00e5ff")
                    .setThumbnail("https://cdn.discordapp.com/attachments/1030499174715752488/1130609318551621803/123444d.png")
                    .setImage('https://cdn.discordapp.com/attachments/1030499174715752488/1130614627856830606/DR3P1234j.png')
            ...
            if (hasRole) {
              ...
              const acceptEmbed = new EmbedBuilder()
                .setColor("#00d0ff")
                .setAuthor({ name: 'DHRUVAM', iconURL: 'https://cdn.discordapp.com/attachments/1030499174715752488/1130609318551621803/123444d.png' })
                .setThumbnail(`https://cdn.discordapp.com/attachments/1030499174715752488/1130619268925497494/Untitled_design_1.gif`)
                .setImage('https://cdn.discordapp.com/attachments/913793437499801611/1041425319032270888/34Untitled-1.png')
                .addFields([
                  {
                    name: '\n\u200b\nServer Name ',
                    value: `\`\`\`DHRUVAM\`\`\``,
              ...
              try {
                ...
                console.log(`Direct message sent successfully to ${user.user.username}`);
                return;
              } catch (error) {
                if (error.code === 50007) {
                  interaction.reply({
          ...
          if (interaction.customId == "ap_apply") {
            ...
            const pendingEmbed = new EmbedBuilder()
              ...
              .setImage('https://cdn.discordapp.com/attachments/913793437499801611/1041427167818559630/U4ntitled-1.png')
              .setTimestamp()
              .setFooter({ text: `${interaction.user.username}`, iconURL: interaction.user.displayAvatarURL({ dynamic: true }) });
          ...
          if (interaction.customId === 'application_modal') {
            ...
            const rejectEmbed = new EmbedBuilder()
              ...
              .setImage('https://cdn.discordapp.com/attachments/913793437499801611/1041427167483011263/U55ntitled-1.png')
              .setTimestamp()
              .setFooter({ text: `${interaction.user.username}`, iconURL: interaction.user.displayAvatarURL({ dynamic: true }) });
